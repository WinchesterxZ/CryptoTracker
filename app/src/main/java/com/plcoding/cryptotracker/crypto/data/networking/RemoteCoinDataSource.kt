...
class RemoteCoinDataSource(
    ...
    override suspend fun getCoinHistory(
        ...
        val startMillis = start.withZoneSameInstant(ZonedDateTime.now().zone).toInstant().toEpochMilli()
        val endMillis = end.withZoneSameInstant(ZonedDateTime.now().zone).toInstant().toEpochMilli()
